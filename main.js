...
class MainScene extends Phaser.Scene {
	...
	preload() {
		...
		this.load.tilemapTiledJSON("map", "tilesets/map-large.json");

		this.load.image("coin", "coin.png");
		this.load.image("enemy", "renamed.png");
...
objectLayer.objects.forEach((o) => {
	...
	hitPlayer(player, enemy) {
		this.physics.pause();
		player.setTint(0x0000ab); // light blue death color for me
this.music.stop()
